...
const Navigation = props => (
    <div className="navigation">
        <h2 className="navigation_h2"><Link to="/home">Dash Home</Link></h2>
        <h2 className="navigation_h2"><Link to="/add-brand">Add A Brand</Link></h2>
        ...
        <h2 className="navigation_h2"><Link to="/photo-storage">Photo Storage</Link></h2>
    </div>
);
